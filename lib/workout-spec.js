...
// Maps a `suggest` focus region to a sensible default circuit of library moves.
// Names must exist in /v6/movements; builder will validate + auto-correct measure.
const REGION_TEMPLATES = {
  'Chest & Shoulders': ['Bench Press', 'Overhead Press', 'Chest Fly'],
  'Back & Biceps': ['Row', 'Lat Pulldown', 'Bicep Curl'],
  'Legs / Lower Body': ['Squat', 'Romanian Deadlift', 'Calf Raise'],
